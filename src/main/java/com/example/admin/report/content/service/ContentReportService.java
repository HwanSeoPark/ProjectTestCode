package com.example.admin.report.content.service;

import com.example.account.user.domain.User;
import com.example.account.user.repository.LoginRepository;
import com.example.admin.report.content.dto.ContentReportRequest;
import com.example.admin.report.content.dto.ContentReportResponse;
import com.example.admin.report.content.entity.ContentReport;
import com.example.admin.report.content.entity.ReportData;
import com.example.admin.report.content.exception.ContentReportException;
import com.example.admin.report.content.repository.ContentReportRepository;
