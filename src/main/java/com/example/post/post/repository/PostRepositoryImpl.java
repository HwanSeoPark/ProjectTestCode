...
import static com.example.post.comment.domain.QComment.comment;
import static com.example.post.post.domain.QPost.post;
import static com.example.post.tag.domain.QTag.tag;
